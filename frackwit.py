...
def show_help():
    ...
    help_lines = ['FrackWIT',
              ...
              '   button',
              'o Named Area: Choose a particular named area (Placemark) from a file with many areas (sets',
              '   of coordinates). If left empty the first set of coordinates is chosen',
